...
#define MAX_ICMPV6LEN  1280
     ...
     * using the remote address is prefered since it makes debugging and understanding
     ...
     * Windows did not like the administratively prohibited return code (no fast fail)
     */
