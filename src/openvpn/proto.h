 ...
 * @param af Address family for which the checksum is calculated AF_INET or AF_INET6
 ...
 */
uint16_t
ip_checksum(const sa_family_t af, const uint8_t *payload, const int len_payload, const uint8_t *src_addr,
