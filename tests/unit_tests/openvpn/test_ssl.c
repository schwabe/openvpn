                    ...
                    struct key2 *statickey)
{
    ...
    if (epoch)
    {
        ...
        epoch_init_key_ctx(&co, &kt, KEY_DIRECTION_BIDIRECTIONAL, &e1, 5);
...
test_data_channel_known_vectors_run(bool epoch)
{
    ...
    if (epoch)
    {
        ...
        {0x97, 0xbe, 0x28, 0x98, 0x2e, 0xc2, 0xbb, 0xc8,
         0xad, 0x75, 0x5b, 0x94, 0x91, 0xf4, 0x76, 0x64};
    ...
    if (epoch)
    {
        const uint8_t bytesat14[6] = {0xef, 0x13, 0x75, 0x16, 0x6b, 0xee};
