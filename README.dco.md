...
- topology subnet is the only supported `--topology`
...
- --multihome option not supported. Will probably not be supported,
  but instead multiple sockets will be needed/supported in a future version
